...
public class TweetParser {
    ...
    static List<String> parseAndCleanSentence(String sentence) {
        ...
        List<String> cleanedWords = new LinkedList<>();
        for (String str : words) {
            String cleaned = cleanWord(str);
    ...
    static List<List<String>> parseAndCleanTweet(String tweet) {
        List<List<String>> cleanedList = new LinkedList<>();
        List<String> sentenceList = tweetSplit(removeURLs(tweet));
        for (String str : sentenceList) {
            List<String> sentence  = parseAndCleanSentence(str);
            if (!sentence.isEmpty()) {
    ...
    public static List<List<String>> csvDataToTrainingData(
        ...
        for (String sentence : data) {
            List<List<String>> ls = parseAndCleanTweet(sentence);
            if (!ls.isEmpty()) {
                tweets.addAll(ls);
            }
        }
